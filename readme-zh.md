...
| **@bitfrog-ui-design** | Default | 调研和写文档 — 不改代码 |

**设置方法：** 点击 Chat 视图中的权限级别指示器（VS Code 1.111+）。

**经验法则：** 思考阶段用 **Default**（brainstorm、plan、review），行动阶段用 **Bypass**（execute、debug）。
...
| **@bitfrog-ui-design** | JTBD 分析、用户旅程、交互流程 | 做面向用户的功能 | Default |
